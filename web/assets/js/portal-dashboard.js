...
(function () {
    ...
    if (btnAddPlan)
        btnAddPlan.addEventListener('click', function () { openPlanModal(null); });
    ...
    if (outPlansClick)
        outPlansClick.addEventListener('click', function (e) {
    ...
    if (btnBlockOverdue)
        btnBlockOverdue.addEventListener('click', function () {
            var btn = this;
            btn.disabled = true;
    ...
    if (btnUnblockPaid)
        btnUnblockPaid.addEventListener('click', function () {
            var btn = this;
            btn.disabled = true;
            btn.innerHTML = '<span class="spinner-border spinner-border-sm me-1"></span>Executando...';
